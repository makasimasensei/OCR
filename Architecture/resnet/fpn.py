...
if __name__ == "__main__":
    ...
    fpn1 = FeaturePyramid()
    # 使用示例输入进行测试
    input5 = torch.randn(1, 2048, 20, 20)
    input4 = torch.randn(1, 1024, 40, 40)
    input3 = torch.randn(1, 512, 80, 80)
    input2 = torch.randn(1, 256, 160, 160)
    feature = [input2, input3, input4, input5]

    outputs = fpn1(feature)
    total_params = sum(param.nelement() for param in fpn1.parameters())
    print(total_params)
    p = outputs
