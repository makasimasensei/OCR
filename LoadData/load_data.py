...
from LoadData.build_dataloader import *
import os
...
class MyDataloader:
    ...
    def train_dataloader_fun(self, mode='train', batch_size=4, num_workers=4, augmentation=False):
        # 定义训练集数据读取器，进程数设置为4
...
if __name__ == "__main__":
    ic15_data_path = \
        "E:/anaconda/envs/pytorch/graduation_project/train_data/synthtext/text_localization"
    train_data_label = "E:/anaconda/envs/pytorch/graduation_project/train_data/synthtext/text_localization/train.txt"
    eval_data_label = "E:/anaconda/envs/pytorch/graduation_project/train_data/synthtext/text_localization/eval.txt"
    train_dataloader = \
